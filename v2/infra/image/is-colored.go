...
func (ip *ImageEditor) IsColored() bool {
...
func (ip *ImageEditor) getYCbCrHistograms() (cbHist [256]int, crHist [256]int) {
...
func (d *ImageEditor) colorPrecision(cbHistOrig, crHistOrig [256]int, cutoff float64, diffThreshold int) (bool, bool) {
